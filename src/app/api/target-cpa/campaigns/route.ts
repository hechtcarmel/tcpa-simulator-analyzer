...
import { getCampaignsWithBothStrategies } from '@/lib/db/queries';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const campaigns = await getCampaignsWithBothStrategies({
      startDate: validatedParams.startDate,
      endDate: validatedParams.endDate,
      phase: validatedParams.phase,
      mode: validatedParams.mode,
    });
    console.log('Query returned campaigns:', campaigns.length);
